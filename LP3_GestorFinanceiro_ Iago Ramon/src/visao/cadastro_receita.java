...
public class cadastro_receita extends JFrame {
	...
	private JLabel lbl_descricao_receita;
	...
	public JPanel getPanel_cadastro_despesa() {
		if (panel_cadastro_despesa == null) {
			...
			panel_cadastro_despesa.add(getLbl_descricao_receita());
	...
	public JLabel getLblDashboard_2() {
		if (lblNovaDespesa == null) {
			lblNovaDespesa = new JLabel("Nova Receita");
	...
	public JButton getBtn_cadastrar() {
		if (btn_cadastrar == null) {
			...
			btn_cadastrar.setBounds(282, 282, 121, 23);
		}
		return btn_cadastrar;
	}

	public JLabel getLbl_descricao_receita() {
		if (lbl_descricao_receita == null) {
			lbl_descricao_receita = new JLabel("Descri\u00E7\u00E3o: ");
			lbl_descricao_receita.setFont(new Font("Arial", Font.PLAIN, 13));
			lbl_descricao_receita.setBounds(41, 205, 137, 14);
		}
		return lbl_descricao_receita;
	}
...
//	}
	...
	public JComboBox<String> getComboBox_mes() {
		if (comboBox_mes == null) {
			...
			comboBox_mes.setModel(
					new DefaultComboBoxModel<String>(new String[] { "Janeiro", "Fevereiro", "Mar\u00E7o",
	...
	public JSpinner getSpinner_ano() {
		if (spinner_ano == null) {
			...
			spinner_ano
					.setModel(new SpinnerNumberModel(new Integer(2021), new Integer(2021), null, new Integer(1)));
